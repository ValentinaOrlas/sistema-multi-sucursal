...
class ProductoModel(Base):
    ...
    stock_minimo_global: Mapped[int] = mapped_column(Integer, nullable=False, default=0)

    __table_args__ = (
        CheckConstraint("stock_minimo_global >= 0", name="check_stock_minimo_global_positivo"),
    )

    # Relaciones
    categoria: Mapped["CategoriaModel"] = relationship("CategoriaModel", back_populates="productos")