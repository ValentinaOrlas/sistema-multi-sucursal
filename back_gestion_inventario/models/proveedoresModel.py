...
class ProveedorModel(Base):
    ...
    tiempo_entrega_promedio_dias: Mapped[int] = mapped_column(
    ...
    # Relaciones
    ordenes_compra: Mapped[List["OrdenCompraModel"]] = relationship(
        "OrdenCompraModel", back_populates="proveedor"
    )
