...
def crear(datos: OrdenCompraCreateRequest, usuario=Depends(obtener_usuario_actual)):
...
def listar(sucursal_id: int | None = None, proveedor_id: int | None = None,
           producto_id: int | None = None, usuario=Depends(obtener_usuario_actual)):
...
def obtener(orden_id: int, usuario=Depends(obtener_usuario_actual)):
...
def cancelar(orden_id: int, usuario=Depends(obtener_usuario_actual)):
